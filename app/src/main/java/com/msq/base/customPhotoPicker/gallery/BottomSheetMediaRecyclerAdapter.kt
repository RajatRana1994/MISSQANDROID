package com.msq.base.customPhotoPicker.gallery
...
import com.msq.base.customPhotoPicker.utils.GeneralUtils.getScreenWidth
...
import com.msq.R
import com.msq.databinding.RecyclerItemDateHeaderBinding
import com.msq.databinding.RecyclerItemMediaBinding
...
class BottomSheetMediaRecyclerAdapter(private val mMediaList: ArrayList<MediaModel>, val mInterface: MediaClickInterface, val mContext: Context):
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if (holder is HeaderViewHolder) holder.bind(mMediaList[holder.bindingAdapterPosition])
        else if (holder is MediaViewHolder) holder.bind(holder.bindingAdapterPosition)
    }
