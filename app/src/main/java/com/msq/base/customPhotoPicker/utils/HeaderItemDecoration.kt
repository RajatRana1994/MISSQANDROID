package com.msq.base.customPhotoPicker.utils
...
import com.msq.base.customPhotoPicker.utils.GeneralUtils.convertPixelsToDp
...
class HeaderItemDecoration(private val mListener: StickyHeaderInterface, private val context: Context): RecyclerView.ItemDecoration() {
    ...
    override fun onDrawOver(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        currentHeader.setPadding(
            (currentHeader.paddingLeft - convertPixelsToDp(5f, context)).toInt(),
