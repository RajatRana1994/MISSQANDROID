...
internal fun ImageView.loadGif(img: Any/*,place:Int=R.drawable.ic_notif*/) {
    when (img) {
...
//internal fun ImageView.loadProducts(img: Any, place: Int = R.drawable.ic_sides) {
//    when (img) {
//        is String, is Int, is Uri -> {
//            Glide.with(this.context).load(img).diskCacheStrategy(
//                DiskCacheStrategy.ALL
